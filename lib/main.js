...
var BookmarksUI = {
	...
	getMarksFrom : function () {
		...
		for (var i=0; i < childCount; i++) {
			...
			if (childNode.type == 0 || childNode.type == 5 || childNode.type == 6)	
				this.Bookmarks.push(new this.Mark(childNode));
				
		}
		
		// this.Bookmarks.print();
	...
	Mark : function (childNode) {
		...
		BookmarksUI.uri[childNode.itemId] = childNode.uri;
		
	},
	
	openAllMarks : function() {
...
// *	Open a Link 
panel.port.on ("openLink", function (id , button) {
